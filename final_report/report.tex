...
vertices.
Therefore, a dense representation of the adjacency matrix would have $5 * 10^{12}$ vertices. This is clearly not scalable. Since most pages only have 100%TODO
...
\begin{figure}[H]
    \includegraphics[width=8cm]{in_degree_dist}
\end{figure}

\begin{figure}[H]
    \includegraphics[width=8cm]{out_degree_dist}
\end{figure}
...
\begin{tabular}{rlr}
    \toprule
    article\_id & title & katz\_centrality\\
    \midrule
...
Using 20 iterations to calculate the radius and diameter, the radius and diameter are both 33. That is, the eccentricity of the 20 tested nodes are all 33.
