...
% With this information, the entire matrix can be accurately represented efficiently in memory.
% With the sparse format, the entire adjacency matrix can be represented with less than 4GB of memory.
