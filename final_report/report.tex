...
\begin{figure}
    \centering
    \caption[]{Indegree Statistics}
    \begin{tabular}{rrrrr}
        \toprule
        Q1 & Median & Mean & Q3 & Maximum\\
        \midrule
        4 & 19 & 91.46176 & 81 & 1,305,902\\
        \bottomrule
    \end{tabular}
\end{figure}

\begin{figure}[H]
    \caption{Entire Network Degree Distribution}
    \centering
    \includegraphics[width=5cm]{in_degree_dist}
\end{figure}

\begin{figure}[H]
    \caption{Entire Network Degree Distribution}
    \centering
    \includegraphics[width=5cm]{out_degree_dist}
\end{figure}
