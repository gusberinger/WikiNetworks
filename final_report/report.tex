...
The outdegree distribution grows before declining. It has a much smaller maximum of 11,897 vertices. This is because the outdegree is limited by the size of the article, but the indegree is only limited by the relevence of the article and the size of the graph.
...
The biggest difference with the closness centrality metric is that the World War II metric is at the top. This is the only article that is not a country or a reference vertice to make the top of the list for the metrics.
...
In order to properly identify important articles, the closeness centrality metric is better.
The closeness centrality metric promotes highly referenced topics, 
